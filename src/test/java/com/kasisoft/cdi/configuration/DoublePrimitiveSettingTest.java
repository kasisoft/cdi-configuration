...
public class DoublePrimitiveSettingTest extends AbstractEjbTest {
  ...
  public Object[][] data() {
    return new Object[][] {
      ...
      { Double1.class.getSimpleName(), 1.0 },
      { Double2.class.getSimpleName(), -1.0  },
      // properties are set to: INF, -INF
      { Double3.class.getSimpleName(), Double.POSITIVE_INFINITY },
      { Double4.class.getSimpleName(), Double.NEGATIVE_INFINITY  },
      // properties are set to: NAN
      { Double5.class.getSimpleName(), Double.NaN },
      // properties aren't set. defaults are set to: 1.0, -1.0
      { Double6.class.getSimpleName(), 1.0  },
      { Double7.class.getSimpleName(), -1.0 },
      // properties with customized names
      { Double8.class.getSimpleName(), 1.0 },
    };
  }
